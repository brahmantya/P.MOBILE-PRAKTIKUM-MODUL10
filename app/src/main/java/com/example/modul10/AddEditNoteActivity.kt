...
class AddEditNoteActivity : AppCompatActivity() {
    companion object {
        const val EXTRA_ID = "com.example.modul10.EXTRA_ID"
        const val EXTRA_JUDUL = "com.example.modul10.EXTRA_JUDUL"
        const val EXTRA_DESKRIPSI = "com.example.modul10.EXTRA_DESKRIPSI"
        const val EXTRA_PRIORITAS = "com.example.modul10.EXTRA_PRIORITAS"
